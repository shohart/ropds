...
async fn build_library_summary(pool: &DbPool) -> String {
    ...
    format!(
        "📚 <b>Частное зеркало Флибусты</b>\n\n\
         📖 Книг: <b>{}</b>\n\
         ✍️ Авторов: <b>{}</b>\n\
         📚 Серий: <b>{}</b>\n\
         🕒 Последнее пополнение: {}\n\n\
         🔎 Отправьте название книги или фамилию автора — просто текстом.\n\
         👆 В списке нажмите номер нужной книги.\n\
         ⬇️ Выберите формат — книга отправится файлом.\n\n\
         🌐 Оригинал базы: <a href=\"https://flibusta.is/\">flibusta.is</a>",
        fmt_thousands(books),
